...
def minBoundingRect(hull_points_2d):
    ...
    min_bbox = (0, 99999, 0, 0, 0, 0, 0, 0)  # rot_angle, area, width, height, min_x, max_x, min_y, max_y
    for i in range(len(edge_angles)):
    ...
    return angle, min_bbox[1], min_bbox[2], min_bbox[
        3], center_point, corner_points  # rot_angle, area, width, height, center_point, corner_points
